...
export const ProtectedLayout: React.FC = () => {
    ...
    const {
        ...
        isConfirmationModalOpen, confirmMessage, confirmText, closeConfirmationModal, confirmDelete,
    ...
    return (
        <div className="flex h-screen bg-slate-100">
            ...
            {isEventModalOpen && <EventModal eventToEdit={eventToEdit} onClose={closeEventModal} onSubmit={async (data) => { try { await handleEventSubmit(data, eventToEdit); closeEventModal(); } catch (err) { /* error alerted in handler */ } }} />}
