...
import { FileArchive, Download, Loader2, FileSpreadsheet } from 'lucide-react';
        ...
        <div className="bg-white p-6 rounded-xl shadow-md space-y-6">
            ...
            <div className="flex flex-col md:flex-row justify-between md:items-center gap-4 border-b border-slate-100 pb-5">
                <div>
                    ...
                    <p className="text-sm text-slate-500 mt-0.5">Comprehensive list of participants across events with date-wise ZIP export.</p>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <button
                        ...
                        className="inline-flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-4 py-2.5 rounded-xl shadow-sm hover:shadow transition-all disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                    ...
                    <button
                        ...
                        className="inline-flex items-center justify-center gap-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold px-3.5 py-2.5 rounded-xl border border-slate-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input
                        ...
                        className="w-full px-3.5 py-2.5 text-sm border border-slate-200 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
                        value={searchTerm}
                ...
                <div>
                    ...
                    <select
                        ...
                        className="w-full px-3.5 py-2.5 text-sm border border-slate-200 bg-white rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
            ...
            <div className="flex flex-col md:flex-row justify-between items-center pt-2 gap-4">
                <div className="flex items-center space-x-2 text-sm text-slate-600">
                    ...
                    <select
                        ...
                        className="px-2.5 py-1.5 border border-slate-200 rounded-lg shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500 text-sm bg-white"
