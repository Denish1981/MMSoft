...
ADD COLUMN IF NOT EXISTS stall_registration_id INTEGER 
REFERENCES stall_registrations(id) ON DELETE CASCADE;

ALTER TABLE users ADD COLUMN IF NOT EXISTS full_name VARCHAR(255);
ALTER TABLE users ADD COLUMN IF NOT EXISTS mobile_number VARCHAR(20);
ALTER TABLE users ADD COLUMN IF NOT EXISTS tower_number VARCHAR(50);
ALTER TABLE users ADD COLUMN IF NOT EXISTS flat_number VARCHAR(50);
