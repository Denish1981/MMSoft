        ...
        <HashRouter>
            ...
            <Routes>
                ...
                >
                    ...
                    <Route path="/reports" element={<ProtectedRoute permission="page:reports:view"><Reports contributions={contributions} sponsors={sponsors} vendors={vendors} expenses={expenses} quotations={quotations} budgets={budgets} festivals={festivals} tasks={tasks} users={users} onViewHistory={handleViewHistory} /></ProtectedRoute>} />
