...
import { Calendar, CheckSquare, Square, Clock, Building2, CheckCircle2 } from 'lucide-react';
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 pb-4">
                <div>
                    <h3 className="text-lg font-bold text-slate-900 flex items-center gap-2">
                        <Calendar className="w-5 h-5 text-blue-600" /> Choose Events to Register ({selectedEventIds.length}/{events.length})
                    </h3>
                    <p className="text-xs text-slate-500 mt-0.5">
                        Select one or more events from the list below to register multiple family members at once.
                    </p>
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    >
                        {isAllSelected ? (
                            ...
                            <>
                                <CheckSquare className="w-4 h-4 text-blue-600" /> Select All ({events.length})
                            </>
                        )}
                    </button>
                </div>
